...
public class CampA extends Campany {
    ...
    public static void deposit() {
        ...
        boolean b2 = false;
        //CampA ct;
        ArrayList<CampA> ctAList = new ArrayList<>();
        ArrayList<CampA> histAList = new ArrayList<>();
        ListIterator<CampA> li = ctAList.listIterator();
