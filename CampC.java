...
public class CampC extends Campany {
    ...
    public static void deposit() {
        ...
        boolean b2 = false;
        //CampA ct;
        ArrayList<CampC> ctList = new ArrayList<>();
        ArrayList<CampC> histAList = new ArrayList<>();
        ListIterator<CampC> li = ctList.listIterator();
        ListIterator<CampC.History> pi = histList.listIterator();
        for (CampC ct : ctList) {
